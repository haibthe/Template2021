...
class CircularImageView @JvmOverloads constructor(
  ...
  private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
    ...
    circleColor = attributes.getColor(R.styleable.CircularImageView_civ_circle_color, Color.TRANSPARENT)
    ...
    if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
      ...
      borderColor =
        attributes.getColor(R.styleable.CircularImageView_civ_border_color, Color.TRANSPARENT)
  ...
  override fun setScaleType(scaleType: ScaleType) {
    require(
      ...
      "ScaleType $scaleType not supported. " +
        "Just ScaleType.CENTER_CROP, ScaleType.CENTER_INSIDE & ScaleType.FIT_CENTER are available for this library."
    }
